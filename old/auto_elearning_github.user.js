// ==UserScript==
// @name         Auto E-Learning Bot (v14 - All-in-One)
// @namespace    http://tampermonkey.net/
// @version      14.0
// @description  自動掛網、一鍵自動作答、手動題庫搜尋、自動填寫問卷
// @author       Shengyang
...
(function () {
    'use strict';
    console.log('[AutoBot v14] Init');

    const DB_URL = "https://raw.githubusercontent.com/xerion79585/Auto-E-Learning/main/Desktop/AutoElearning/questions.json";
    ...
    // ============================================================
    // Shared: Load Database (with progress UI)
    // ============================================================
    function loadDatabase(statusEl) {
        return new Promise((resolve) => {
            ...
            `;
            GM_xmlhttpRequest({
                method: "GET", url: DB_URL, responseType: "json",
                onprogress: (e) => {
    ...
    // Quick fetch (no UI, for solver button)
    ...
    async function oneClickSolve() {
        ...
        try {
            ...
            if (btn) { btn.disabled = false; btn.innerText = '⚡自動作答'; }
        }
    }

    // ============================================================
    // MANUAL SEARCH PANEL (v13 logic)
    // ============================================================
    ...
    setInterval(() => {
        ...
        // 3. Exam Page → Two buttons on the left + toggleable search panel
